<x-adminlte-modal id="nuevoCliente" title="Nuevo Cliente" size="md" theme="success" icon="fas fa-plus" v-centered static-backdrop scrollable>
    <div class="container-fluid row">
        ...
        <div class="col-lg-12 p-1">
            <form class="form-group">
                <x-adminlte-input type="text" id="nombre" name="nombre" placeholder="*Nombre de cliente">
                ...
                <x-adminlte-input type="email" id="email" name="email" placeholder="Email de cliente">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
                ...
                <x-adminlte-input type="text" id="rfc" name="rfc" placeholder="RFC de cliente">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
