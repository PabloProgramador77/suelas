<x-adminlte-modal id="editarCliente" title="Editar Usuario" size="md" theme="info" icon="fas fa-user-edit" v-centered static-backdrop scrollable>
    <div class="container-fluid row">
        ...
        <div class="col-lg-12 p-1">
            <form class="form-group">
                <x-adminlte-input type="text" id="nombreEditar" name="nombreEditar" placeholder="*Nombre de cliente">
                ...
                <x-adminlte-input type="email" id="emailEditar" name="emailEditar" placeholder="Email de cliente">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
                ...
                <x-adminlte-input type="text" id="rfcEditar" name="rfcEditar" placeholder="RFC de cliente">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
