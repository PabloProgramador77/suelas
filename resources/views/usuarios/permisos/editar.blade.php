<x-adminlte-modal id="editarPermiso" title="Editar Permiso" size="md" theme="info" icon="fas fa-user-cog" v-centered static-backdrop scrollable>
    <div class="container-fluid row">
        ...
        <div class="col-lg-12 p-1">
            <form class="form-group">
                <x-adminlte-input type="text" id="nombreEditar" name="nombreEditar" placeholder="*Nombre de permiso">
