...
class PedidoController extends Controller
{
    ...
    public function create( Request $request )
    {
        try {
            ...
            if( file_exists( public_path('pdf/').'nota'.$request->id.'.pdf' ) ){
                            ...
                            <table style="width: 100%; height: auto; overflow: auto; border-collapse: collapse;">
                                <tr style="background-color: #3498DB;">
                                    ...
                                    foreach( $pedido->suelas as $suela ){
                                        ...
                                        <td style="width: 16.6%; height: auto; font-size: 12px; text-align: center; padding-top: 10px; margin: 0 auto;"><b>'.$suela->nombre.'</b></td>
                                        <td style="width: 16.6%; height: auto; font-size: 12px; text-align: center; padding-top: 10px; margin: 0 auto;"><b>$'.$suela->precio.'</b></td>
                                        <td style="width: 16.6%; height: auto; font-size: 12px; text-align: center; padding-top: 10px; margin: 0 auto;"><b>'.$suela->descripcion.'</b></td>
                                        <td style="width: 16.6%; height: auto; font-size: 12px; text-align: center; padding-top: 10px; margin: 0 auto;"><b>'.$suela->color.'</b></td>
                                        <td style="width: 16.6%; height: auto; font-size: 12px; text-align: center; padding-top: 10px; margin: 0 auto;"><b>'.$suela->corrida.'</b></td>
                                        <td style="width: 16.6%; height: auto; font-size: 12px; text-align: center; padding-top: 10px; margin: 0 auto;"><b>$'.$suela->pivot->importe.'</b></td></tr>';
                                ...
                                <tr style="padding: 10px;">
                                    <td colspan="3" style="font-size: 12px; text-align: right; border-bottom: 1px solid #7B7D7D; border-top: 1px solid #7B7D7D;"><b>Total de Pares:</b></td>
